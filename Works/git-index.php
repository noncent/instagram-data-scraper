                    ...
                    <form class="navbar-form">
                        <div class="form-group" style="display:inline;">
                            <div class="input-group" style="display:table;">
                                <input class="form-control" id="txtSearch" name="txtSearch" placeholder="Use single space to seprate multiple keyword as #hashtag or @account or both..." autocomplete="off" autofocus="autofocus" type="text" value="#DigitasLBi #BiggBoss #freedomIndia #GreenLights" />
                    ...
                    <div class="row">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-dashboard"></i> User's Input Details
